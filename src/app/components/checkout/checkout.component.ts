...
export class CheckoutComponent implements OnInit {
  ...
  onSubmit(){
    ...
    console.log(`Customer is ${this.checkoutFormGroup.get('customer')?.value}`);
    console.log(`His shipping address is : ${this.checkoutFormGroup.get('shippingAddress')?.value}`);
    console.log(`His billing address is : ${this.checkoutFormGroup.get('billingAddress')?.value}`);
    console.log(`His credit card information is : ${this.checkoutFormGroup.get('creditCard')?.value}`);
  }
